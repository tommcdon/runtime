...
namespace System.Diagnostics
{
    public partial class StackTrace
    {
        ...
        private static partial void GetStackFramesInternal(ObjectHandleOnStack sfh, [MarshalAs(UnmanagedType.Bool)] bool fNeedFileInfo, ObjectHandleOnStack e, int asyncBehavior);

        internal static void GetStackFramesInternal(StackFrameHelper sfh, bool fNeedFileInfo, Exception? e)
            => GetStackFramesInternal(ObjectHandleOnStack.Create(ref sfh), fNeedFileInfo, ObjectHandleOnStack.Create(ref e), (int)sfh.AsyncBehavior);
        ...
        private void CaptureStackTrace(int skipFrames, bool fNeedFileInfo, Exception? e)
        {
            ...
            StackF.AsyncBehavior = e is null ? _asyncBehavior : StackTraceAsyncBehavior.Default;
